#Greetings and don't be tired, dear visitor of CS50. In fact, I solved this code with the help of the course instructor and the children in the class, and it can almost be said that it was worked and debugged as a group. If you think there is a problem, please let me know so that I can write the project again from scratch. This is my WhatsApp number +989140750087
...
def register():
    ...
    if request.method == "POST":
        ...
        if len(username) < 4:
            return apology("at least 4 characters", 403)

        # Check for password to be the same
        if password != confirmation:
            return apology("Passwords!", 400)
